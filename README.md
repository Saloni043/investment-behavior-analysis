...
| Task | Description |
|------|-------------|
| 1 | Data Overview — structure, entries, data types |
| 2 | Gender Distribution — pie & bar charts |
| 3 | Descriptive Statistics — mean, median, std for numerical columns |
| 4 | Most Preferred Investment Avenue |
| 5 | Reasons for Investment (by instrument) |
| 6 | Savings Objectives |
| 7 | Common Information Sources |
| 8 | Average Investment Duration |
